...
%Upper boundary
sysparams.bound_list{length(sysparams.bound_list) + 1} = MakeLinearBoundaryObject([3.1 1], size_mult * [2 5]);

%Lower boundary
sysparams.bound_list{length(sysparams.bound_list) + 1} = MakeLinearBoundaryObject([-3.1 1], size_mult * [7 5]);
