    ...
    for cur_force_mult =  2 * .5 * 1 * 2 * .5 * (.25)
        for wall_force_mult = 1 * [3];
            for rh_wave_vec = (2* pi/5) * (1.2:.2:2.4)
                ...
                sysparams.folder_path = sprintf('../Outputs/SeptSquareShift/Graining%d/Radius%f/Wavevec%f/ArchOutputStrength%f/WallMult%f/',  sysparams.graining, landmark_cell_radius, rh_wave_vec,  cur_force_mult, wall_force_mult);
