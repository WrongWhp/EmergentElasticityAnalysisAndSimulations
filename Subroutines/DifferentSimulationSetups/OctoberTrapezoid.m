...
for cur_force_mult = .5 *  2 * [ 1 1.5 4];
    for wall_force_mult = 2 * [.5] * 1;
        for rh_wave_vec =  2* pi/3 * (1.0:.4:2);
            ...
            sysparams.folder_path = sprintf('../Outputs/TrapezoidOctober/Graining%d/Angle%f/Wavevec%f/ArchOutputStrength%f/WallMult%f/SharpFields%d/', sysparams.graining, sysparams.rh_rot_angle, rh_wave_vec, cur_force_mult, wall_force_mult, sysparams.sharp_landmark_masks);
