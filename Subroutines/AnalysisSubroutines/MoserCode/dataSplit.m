function splitDataArray = dataSplit(x, y, t, hdDir, p)
...
x3 = zeros(numSamples,1);
y3 = zeros(numSamples,1);
t3 = zeros(numSamples,1);
if hdFlag
    hdDir3 = zeros(numSamples,1);
end
totSamp3 = 0;

x4 = zeros(numSamples,1);
y4 = zeros(numSamples,1);
t4 = zeros(numSamples,1);
if hdFlag
    hdDir4 = zeros(numSamples,1);
end
totSamp4 = 0;
