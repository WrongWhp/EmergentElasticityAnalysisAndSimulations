function [firing_rates] = FiringCountFromRh(rh_accum_array, vu_displacement)
...
filter_radius = .2;
dist_to_use = circshift(CircularRhDist(rh_graining, filter_radius), round(vu_displacement * rh_graining));
