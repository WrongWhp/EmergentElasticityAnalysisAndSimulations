function [output_im_final] = FiringRateImageFromRhDistFancyVisualizationMask(system, rh_accum_array, times_visited_array, visualization_mask)
...
for color_ind = 1:3
    firing_counts = FiringCountFromRhAndVisualizationMask(rh_accum_array, visualization_mask);
